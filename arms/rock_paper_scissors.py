...
label = tk.Label(root,text="select your choice",width = 20,height=4,font=("calibri",15))
label.pack()
...
# Add Labels,Button
wl_label = tk.Label(root,text="",font=("arial",10),width=50,height=4)
wl_label.pack()
button = tk.Button(root,text="Spin",font=("bell mt",10),command=spin)
button.pack()
